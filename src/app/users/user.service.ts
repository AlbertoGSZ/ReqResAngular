...
export class UserService {
  ...
  getUsers(requestedUsersNumber:number, requestedPageNumber:number): Observable<ResponseUsers>{
    return this.http.get<ResponseUsers>(`https://reqres.in/api/users?page=${requestedPageNumber}&per_page=${requestedUsersNumber}`);
  }
